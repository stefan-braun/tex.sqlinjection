...
\newfontfamily\zapfinofont{ZapfinoExtraLT-One}
...
\addtokomafont{chapter}{\normalfont\rmfamily\Huge\leavevmode\color{documentColor}\lsstyle}
\addtokomafont{section}{\normalfont\rmfamily\leavevmode\color{documentColor}\lsstyle\scshape\MakeLowercase}
\addtokomafont{subsection}{\normalfont\rmfamily\leavevmode\color{documentColor}}
...
\setlength{\chapternumberskip}{\textwidth+\marginparsep+0.5\marginparwidth+2cm}
 ...
 \renewcommand*{\chapterformat}{\hspace*{\marginparsep}{\fontsize{100}{70}\zapfinofont\leavevmode\color{black!50}\thechapter\autodot}}
...
\newcommand\mymarginnote[2][0pt]{
  \marginnote{% needs marginnote package
    ...
    % {\color{documentColor}\hrule height 2pt}
    \justify
    \noindent
    #2
    % {\\\color{documentColor}\hrule height 2pt}
...
\cohead{\raggedleft{\textls[100]{ \MakeUppercase \headmark}} \hspace{\chapterHeaderSkip}}
\cehead{\hspace{\chapterHeaderSkip} \raggedright{\textls[100]{\MakeUppercase \headmark}} }
