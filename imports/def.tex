...
\titlecontents{chapter}
  ...
  {\parbox{4.5em}{%
    \hfill\Huge\sffamily\bfseries\color{documentColor}\thecontentspage}%
   \vspace*{-2.3\baselineskip}\leftbar\MakeUppercase{\sffamily\color{black!60}\small\chaptername~\thecontentslabel}\\\sffamily}
  {}{\endleftbar}
